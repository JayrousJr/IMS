...
const Customers = ({ customer }) => {
    ...
    return (
        <Layouts>
            <Head title="Customer" />
            <Description title="Customer List" link="customer.create" />
            {customer.data.length > 0 ? (
                <TableGridComponent rows={customer.data} columns={columns} />
            ) : (
                <NoDataFound />
            )}
